// funders, s_priceFeed, s_addressToAmountFunded
...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", async function () {
          ...
          const sendValue = ethers.utils.parseUnits("1.0") // 1 ETH - parseUnits converts '1' into '1000000000000000000'
          let accountOne

          beforeEach(async function () {
              // deploy FundMe contract w/ hardhat-deploy
              // Use .fixture() w/ tags for coverage
              await deployments.fixture(["all"])

              // Get account to deploy from
              /**Could also get accounts from hardhat.config.js:
               * const accounts = await ethers.getSigners() - gets accounts from network[<network>][accounts]
              ...
              // ethers.getContract() gets most recent deployment of specified contract
          ...
          describe("withdraw", async function () {
              ...
              it("withdraw ETH from a single founder", async function () {
                  // Arrange
                  // hre incl's ethers - provider is an object w/ methods for getting address info from hte chain
                  ...
                  const gasCost = gasUsed.mul(effectiveGasPrice) // .mul as BigNumber function
